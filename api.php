...
function getCitiesForFuelState($stateName) {
    $states = fetchJson('https://hapilocations.web.app/states/101.min.json', 10);
    ...
    $cities = fetchJson('https://hapilocations.web.app/cities/' . rawurlencode((string)$state['id']) . '.min.json', 15);
...
function handleExtraApiRequest() {
    global $fuelApiKeys, $fuelKeyStateFile;
    ...
    if (in_array($action, ['fuel-states', 'fuel-cities', 'fuel-rates'], true)) {
        ...
        if ($action === 'fuel-states') {
            ...
            }, fetchJson('https://hapilocations.web.app/states/101.min.json', 10));
